...
class ImageModule(nn.Module):
    ...
    def __init__(self):
        ...
        vgg_fc7_full_conv = nn.Sequential(
            conv_relu(kernel_size=7, stride=1, in_channels=512, out_channels=4096, padding=(3, 3)),
...
class ContextualImgSegRefExpModel(nn.Module):
    def __init__(self, mlp_hidden, vocab_size, emb_size, lstm_hidden_size):
        super(ContextualImgSegRefExpModel, self).__init__()
        self.text_features = LanguageModule(vocab_size=vocab_size, emb_size=emb_size, num_lstm_layers=1,
                                            hidden_size=lstm_hidden_size)
